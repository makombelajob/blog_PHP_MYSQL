...
<main class="container my-5">
    ...
    <h2 class="fs-1 text-center text-uppercase text-white bg-secondary rounded-3 w-50 m-auto my-3 py-2">🤷‍♂️🤷‍♂️
        <?php if(!isset($posts[0]['title'])) :;?>
        <?php else : ;?>
            <?= $posts[0]['lastname'];?> <?= $posts[0]['firstname'];?>
        <?php endif;?>
        🤷‍♂️🤷‍♂️</h2>
    <div class="">
    ...
    <?php if(!isset($posts[0]['title'])) : ;?>
        <p class="text-center text-uppercase fs-1 text-white bg-danger">Authors doesn't have done anything</p>
    <?php else : ;?>
